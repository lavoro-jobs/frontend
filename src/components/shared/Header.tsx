import { Button, ButtonGroup, Flex, IconButton, Menu, MenuButton, MenuDivider, MenuItem, MenuList, Text } from '@chakra-ui/react'
  ...
  return (
    <header>
      <Flex h="100%" justify="space-between" align="stretch">
        <Link href='/'><h1 className="header-title">Lavoro</h1></Link>
        <nav>
          ...
          <ButtonGroup>
            <Button as='a' href='/signin' bgColor="#E0EAF5" _hover={{bgColor: "gray.300"}} color="#0D2137" h="32px">Sign in</Button>

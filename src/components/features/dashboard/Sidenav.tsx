...
import {
  FiSettings,
  FiMenu, FiSend, FiUserCheck, FiLayers, FiCrosshair,
} from 'react-icons/fi'
...
const ApplicantLinks: Array<LinkItemProps> = [
  ...
  { name: 'Matches', icon: FiUserCheck },
  { name: 'Chats', icon: FiSend },
]

const RecruiterLinks: Array<LinkItemProps> = [
  { name: 'Profile', icon: FiSettings },
  { name: 'Company', icon: FiLayers },
  { name: 'Job Posts', icon: FiCrosshair },
  { name: 'Matches', icon: FiUserCheck },
  { name: 'Chats', icon: FiSend },
]

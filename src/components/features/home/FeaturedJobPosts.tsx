...
import { FaBuilding, FaGraduationCap, FaMoneyBillWave } from "react-icons/fa"
...
export default function FeaturedJobPosts() {
    ...
    return (
        <>
            ...
            {!jobPosts.length && (
                <h3 fontWeight="bold" fontSize="xl" margin="24px auto 0">
                            ...
                            >
                                <CardBody flex="1" display="flex" flexDirection="column">
                                    ...
                                    <Flex mt="8px" align="center" gap="8px">
                                        ...
                                        <Text>
                                            {jobPost.salary_min && <span>${jobPost.salary_min}</span>}{" "}
                                            {jobPost.salary_max && <span>- ${jobPost.salary_max}</span>}
                                        </Text>
                                    </Flex>
                                </CardBody>
                ...
                <ModalContent>
                        ...
                        {modalJob.id && (
                            <Flex direction="column" h="100%" padding="60px 16px 32px">
                                ...
                                <Flex mt="8px" align="center" gap="8px">
                                    <FaMoneyBillWave size="24px" />
                                    <Text>
                                        {modalJob.salary_min && <span>${modalJob.salary_min}</span>}{" "}
                                        {modalJob.salary_max && <span>- ${modalJob.salary_max}</span>}
                                    </Text>
                                </Flex>
                                <Flex mt="24px" gap="8px" flexDirection="column">
                                    <Flex w="100%" className="job-post-description">
                                    ...
                                    <Text className="job-post-description">{modalJob.description}</Text>
                                </Flex>
                            </Flex>
                        )}
                    </ModalBody>
                    ...
                    <ModalFooter>
                        <Text marginBottom="16px" marginLeft="16px" marginRight="auto" className="job-post-description">
                            Active until:{" "}
                            {modalJob.end_date &&
                                new Date(modalJob.end_date).toLocaleDateString("en-US", {
                                    year: "numeric",
                                    month: "long",
                                    day: "numeric",
                                })}
